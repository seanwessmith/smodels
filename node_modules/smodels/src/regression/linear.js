...
class Model{
    ...
    */
    summary(){
        ...
        terminalString += ' '.repeat( Math.max(Math.floor( (b5colW - ' p-value'.length) ), 0)  )+' p-value'
        terminalString += ' '.repeat( Math.floor( (b6colW - ' lower 95%'.length) )  )+' lower 95%'
        terminalString += ' '.repeat( Math.max(Math.floor( (b7colW - ' higher 95%'.length) ), 0)  )+' higher 95%'
